...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 15, fontWeight: '400', color: colors.heading },
  ...
  iconText: { fontSize: 15, fontWeight: '400' },
  rowBody: { flex: 1 },
  rowTitle: { fontSize: 13, color: colors.heading, fontWeight: '400' },
  rowTitleUnread: { fontWeight: '400' },
  ...
  showAllText: { color: colors.primary, fontSize: 13, fontWeight: '400' },
});
