...
const styles = StyleSheet.create({
  ...
  closeText: { fontSize: 15, color: colors.muted, fontWeight: '400' },
  body: { padding: spacing.xl, paddingTop: spacing.xxl },
  heading: { fontSize: 17, fontWeight: '400', color: colors.heading, marginBottom: spacing.lg, paddingHorizontal: 28, textAlign: 'center' },
  ...
  productName: { fontSize: 16, fontWeight: '400', color: colors.heading, marginTop: spacing.md, textAlign: 'center' },
  ...
  amountLabel: { fontSize: 14, color: colors.primaryDark, fontWeight: '400' },
  amountValue: { fontSize: 18, color: colors.accent, fontWeight: '400' },
  sectionLabel: { fontSize: 13, fontWeight: '400', color: colors.primaryDark, marginBottom: spacing.sm },
  detailBox: {
    backgroundColor: colors.surfaceAlt,
    borderRadius: radius.md,
  ...
  requesterName: { fontSize: 14, fontWeight: '400', color: colors.heading, paddingVertical: spacing.sm },
  detailRow: { flexDirection: 'row', paddingVertical: spacing.sm, borderTopWidth: 1, borderTopColor: colors.border },
  detailLabel: { width: 92, fontSize: 13, color: colors.muted, fontWeight: '400' },
  ...
  declineText: { color: colors.danger, fontSize: 15, fontWeight: '400' },
  approveBtn: { backgroundColor: colors.accent, ...shadow(1) },
  approveText: { color: colors.white, fontSize: 15, fontWeight: '400' },
  resultMsg: { textAlign: 'center', color: colors.primary, fontSize: 14, fontWeight: '400', marginVertical: spacing.md },
