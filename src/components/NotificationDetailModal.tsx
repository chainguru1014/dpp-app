...
const styles = StyleSheet.create({
  ...
  closeText: { fontSize: 20, color: colors.muted, fontWeight: '400' },
  body: { padding: spacing.xl, paddingTop: spacing.xxl },
  heading: { fontSize: 23, fontWeight: '400', color: colors.heading, marginBottom: spacing.lg, paddingHorizontal: 28, textAlign: 'center' },
  ...
  amountLabel: { fontSize: 19, color: colors.primaryDark, fontWeight: '400' },
  amountValue: { fontSize: 24, color: colors.accent, fontWeight: '400' },
  sectionLabel: { fontSize: 18, fontWeight: '400', color: colors.primaryDark, marginBottom: spacing.sm },
  detailBox: {
    backgroundColor: colors.surfaceAlt,
    borderRadius: radius.md,
  ...
  requesterName: { fontSize: 19, fontWeight: '400', color: colors.heading, paddingVertical: spacing.sm },
  detailRow: { flexDirection: 'row', paddingVertical: spacing.sm, borderTopWidth: 1, borderTopColor: colors.border },
  detailLabel: { width: 92, fontSize: 18, color: colors.muted, fontWeight: '400' },
  detailValue: { flex: 1, fontSize: 18, color: colors.text },
  ...
  declineText: { color: colors.danger, fontSize: 20, fontWeight: '400' },
  approveBtn: { backgroundColor: colors.accent, ...shadow(1) },
  approveText: { color: colors.white, fontSize: 20, fontWeight: '400' },
  resultMsg: { textAlign: 'center', color: colors.primary, fontSize: 19, fontWeight: '400', marginVertical: spacing.md },
  handledMsg: { textAlign: 'center', color: colors.muted, fontSize: 18, marginTop: spacing.sm },
  ...
  description: { fontSize: 19, color: colors.text, lineHeight: 28, textAlign: 'center' },
});
