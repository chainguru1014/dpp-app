...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 20, fontWeight: '700', color: colors.primary, marginBottom: spacing.md },
  input: {
  ...
  sectionLabel: { fontSize: 16, color: colors.muted, marginTop: spacing.lg, marginBottom: spacing.xs },
  previewCard: {
    flexDirection: 'row',
    gap: spacing.md,
    backgroundColor: colors.surface,
  ...
  previewSub: { fontSize: 16, color: colors.muted, marginTop: 1 },
  previewId: { fontSize: 15, color: colors.placeholder, marginTop: 2 },
