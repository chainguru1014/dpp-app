          ...
          <View style={styles.statCell}>
            ...
            <TouchableOpacity onPress={openPeriodMenu} activeOpacity={0.7}>
              <View ref={periodButtonRef} style={styles.periodButton}>
                ...
                <VectorIcon name="arrow-drop-down" size={27} color={colors.primary} />
              </View>
            </TouchableOpacity>
          </View>
        </View>
          ...
          <ScrollView>
            ...
            {hasMore && (
              <TouchableOpacity style={styles.moreButton} onPress={() => setVisibleCount((c) => c + PAGE_SIZE)} activeOpacity={0.7}>
                <VectorIcon name="expand-more" size={24} color={colors.primary} />
...
const styles = StyleSheet.create({
  ...
  statValue: { fontSize: 21, fontWeight: '600', color: colors.text },
  periodButton: {
    flexDirection: 'row',
    alignItems: 'center',
    borderWidth: 1,
  ...
  periodButtonText: { fontSize: 18, fontWeight: '600', color: colors.primary },
  ...
  periodPopoverText: { fontSize: 20, color: colors.text },
  ...
  tabText: { fontSize: 18, color: colors.muted, fontWeight: '600' },
  tabTextActive: { color: '#fff' },
  emptyText: { textAlign: 'center', color: colors.muted, marginTop: spacing.xxl, fontSize: 21 },
  row: {
    backgroundColor: colors.surface,
    borderRadius: radius.lg,
    borderWidth: 1,
  ...
  rowHeader: { flexDirection: 'row', alignItems: 'center', padding: spacing.md, minHeight: 70 },
  rowImage: { width: 66, height: 66, borderRadius: radius.sm, backgroundColor: colors.surfaceAlt, marginRight: spacing.md },
  rowTagIconBox: {
    width: 66,
    height: 66,
  ...
  rowInfo: { flex: 1 },
  rowRef: { fontSize: 21, fontWeight: '600', color: colors.text },
  rowTime: { fontSize: 18, color: colors.muted },
  badge: { paddingVertical: 6, paddingHorizontal: 15, borderRadius: radius.pill, backgroundColor: colors.surfaceAlt, marginRight: spacing.sm, borderWidth: 1, borderColor: 'transparent' },
  ...
  badgeLatestText: { fontSize: 17, color: colors.primary, fontWeight: '600' },
  badgeSaved: { backgroundColor: colors.success },
  badgeText: { fontSize: 17, color: colors.muted, fontWeight: '600' },
  badgeTextOnColor: { fontSize: 17, color: '#fff', fontWeight: '600' },
  ...
  detailLabel: { fontSize: 18, color: colors.muted },
  detailValue: { fontSize: 18, color: colors.text, fontWeight: '600', flexShrink: 1, textAlign: 'right', marginLeft: spacing.md },
  moreButton: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  moreButtonText: { fontSize: 20, color: colors.primary, fontWeight: '600' },
});
