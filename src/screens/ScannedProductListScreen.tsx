...
export default function ScannedProductListScreen({ navigation, user, onLogout }: Props) {
  ...
  return (
    <AppLayout navigation={navigation} user={user} onLogout={onLogout} showBackButton onBackPress={() => navigation.navigate('Scanner')} title={t('titleMyProducts')} flatContent>
