...
const styles = StyleSheet.create({
  ...
  certBadgeText: { fontSize: 17, color: colors.text, fontWeight: '500', textAlign: 'center' },
  ...
  certLineBody: { fontSize: 17, color: colors.muted, marginTop: 2 },
  tileImg: { width: 38, height: 38 },
  tileDesc: { fontSize: 16, color: colors.placeholder, textAlign: 'center', marginTop: 2 },
  ...
  tileLabel: { fontSize: 16, color: colors.muted, textAlign: 'center' },
  // info / leaf cards
  hintCard: {
    flexDirection: 'row',
    gap: spacing.sm,
  ...
  hintBody: { fontSize: 17, color: colors.primaryDark, lineHeight: 23, marginTop: 2 },
  ...
  infoCardBody: { fontSize: 17, color: colors.muted, marginTop: 1 },
  leafCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: spacing.sm,
  ...
  leafBody: { fontSize: 17, color: colors.primaryDark, lineHeight: 23, marginTop: 2 },
  leafLink: { fontSize: 17, color: colors.accent, fontWeight: '600', marginTop: 4 },
